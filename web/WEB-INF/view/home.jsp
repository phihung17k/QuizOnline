<%-- 
    Document   : home
    Created on : Jan 26, 2021, 1:33:35 PM
    Author     : Win 10
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="loginPage">Login</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="registerPage">Register</a></li>
                    </ul>
                </div>
            </div>
        </nav>
