 ...
 * @author Win 10
 */
@WebFilter(filterName = "AdminSearchFilter", urlPatterns = {"/search"})
public class AdminSearchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            session.removeAttribute("searchEmptyQuestionName");
            ...
            if(optionSearch!=null){
                if(!optionSearch.equals("questionName") && !optionSearch.equals("questionStatus") && !optionSearch.equals("subject")){
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AdminSearchFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AdminSearchFilter(");
